...
<p class="h">On iPhone, the Google Calendar app usually opens empty from a link. Prefer the Add to Calendar link you were sent (Apple Add Event). If you still want Google, open in Safari — it may not prefill.</p>
<p><a class="a" href="${target.replace(/"/g, "&quot;")}">Open in Safari</a></p>
